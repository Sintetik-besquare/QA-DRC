...
*** Test Cases ***
Verify signing up with same value in confirm password field
  ...
  Input Text  //*[@id="signup"]/div[1]/form/div[1]/input  test3@yahoo.com
  ...
  Sleep  5s
  Alert Should Not Be Present  Password confirmation does not match
